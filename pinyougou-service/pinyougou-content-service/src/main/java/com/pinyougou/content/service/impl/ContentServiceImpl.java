...
public class ContentServiceImpl implements ContentService {
     ...
     */
    @Override
    public List<Content> findByContentCategoryId(Long categoryId) {
        try {
            /** 缓存操作*/
            List<Content> contentList = (List<Content>) redisTemplate.boundValueOps("content").get();
            //有缓存则直接返回缓存数据
